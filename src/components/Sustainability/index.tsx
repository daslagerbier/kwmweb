...
const Sustainability = () => {
  ...
  const getOverlayContent = (txt) => {
    switch (txt) {
      case "Text 1":
        return (
          <Overlay
            title={langData[lang].sustainability_t1}
            paragraph={langData[lang].sustainability_p1}
          />
        );
      case "Text 2":
        return (
          <Overlay
            title={langData[lang].sustainability_t2}
            paragraph={langData[lang].sustainability_p2}
          />
        );
      case "Text 3":
        return (
          <Overlay
            title={langData[lang].sustainability_t3}
            paragraph={langData[lang].sustainability_p3}
          />
        );
      case "Text 4":
        return (
          <Overlay
            title={langData[lang].sustainability_t4}
            paragraph={langData[lang].sustainability_p4}
          />
        );
      default:
        return "";
  ...
  return (
    <div
      id="sustainability"
      className={`relative w-full h-96 sustainability  ${classImg1}`}
    >
